...
func (v *Audio) setPropAiReduceNoise(value bool) (changed bool) {
	if v.AiReduceNoise != value {
		v.AiReduceNoise = value
		v.emitPropChangedAiReduceNoise(value)
		return true
	}
	return false
}

func (v *Audio) emitPropChangedAiReduceNoise(value bool) error {
	return v.service.EmitPropertyChanged(v, "AiReduceNoise", value)
}
